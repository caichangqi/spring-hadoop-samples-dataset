...
public class DatasetConfig {
	...
	public DatasetRepositoryFactory datasetRepositoryFactory() {
		...
		datasetRepositoryFactory.setNamespace("file");
		return datasetRepositoryFactory;
	}

	@Bean
	public FileSystemDatasetRepository fileSystemDatasetRepository(){
		FileSystemDatasetRepository fileSystemDatasetRepository = new FileSystemDatasetRepository(hadoopConfiguration, new Path("/user/spring"));
